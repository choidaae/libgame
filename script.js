...
function getInputResult(input) {
    const keyword = {
        ...
        '0423': '자물쇠를 풀자 안에는 양초와 성냥이 가득 들어있다.<br>배터리가 다 된 핸드폰은 꺼져버렸다.<br><br>초에 불을 붙이니 주변이 밝아졌다. <br>눈 앞에 정기간행물, 북큐레이션, 정수기가 보인다.<br><br><span class="small">🔔지문에서 탐색하고자 하는 키워드를 입력해보세요</span>',
        ...
        'BACK': 'BACK...? 뒤집으라는 뜻인가.<br>카드를 뒤집으니 또 다른 문장이 적혀있다.<br><br><span class="books">난 그림자로 끝나고 싶지 않아.<br>난 계속 모습을 드러내고 싶어.<br>"그것"을 꺼뜨리지 말고 내게 가까이 가져와 줘.</span><br><div class="btn-group"><button type="button" class="btn btn-secondary popoverBtn" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-content="책의 날 큐레이션 도서에서 힌트를 찾아보세요.">힌트4</button><button id="backButton" class="btn btn-secondary">이전</button></div>',
