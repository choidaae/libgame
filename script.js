...
let currentStage = 0;
const stages = ['시작', '스위치', '사물함', '0423', '북큐레이션', 'BACK', '촛불', '장미'];
...
function getInputResult(input) {
    const keyword = {
        ...
        '시작': '<br>어둠에 눈이 조금 익숙해지고 나서야 내가 도서관에 들어와있다는 걸 알았다. 쉬는시간에 잠깐 잠든 것 뿐인데 내가 왜 여기 있는거지?<br><br>일단 너무 어두워서 전등 스위치를 켜야겠다.<br><br><br><span class="small">🔔입력 키워드는 <span class="bold">"지문 안"</span>에 숨겨져 있습니다.<br>지문에서 <span class="bold">탐색해야 하는 키워드</span>를 찾아<br>입력창에 입력하세요.<br><br>힌트를 드리죠. 지문에서 너무 어두워 스위치를 켜야겠다고 하네요! <span class="pp">스위치</span>를 입력해보세요.</span>',

        '스위치': '<br><br><br><br>달칵- 달칵- 전등이 켜지지 않는다. 핸드폰 플래시를 켜려고 주머니에 손을 넣으니 구겨진 초대장이 손에 잡힌다.<br>핸드폰 배터리는 5%밖에 남지 않아 금방이라도 꺼질 것 같다. 눈 앞엔 사물함이 보인다.<br><br><br><span class="small">🔔입력 키워드는 미스테리를 해결하기 위한<br><span class="bold">아이템</span>일 수도 있습니다.<br>힌트를 드리죠. 주머니에 손을 넣어 잡힌<br><span class="pp">OOO</span>을 입력창에 입력해보세요.<br><br>🔔그리고 "지문"에서 다음 장면으로 가기 위한<br><span class="bold">탐색 키워드</span>를 찾아 입력하세요.<br>눈 앞에 <span class="pp">무엇</span>이 보이나요?</span>',

        '사물함': '<br><br><br><br>사물함은 네자리의 자물쇠로 잠겨있다.<br>자물쇠 몸통엔 MMDD라고 적혀있다.<br>자물쇠를 여는 단서인 것 같다.<br><br><br><span class="small">🔔입력 키워드는 <span class=bold>문제의 답</span>을 요구하기도 합니다.<br>소지품 내 <span class="pp">아이템을 클릭</span>하여<br>답을 찾을 수도 있습니다.<br>자물쇠 번호를 찾아 입력해보세요.<br><br>힌트는 스토리 흐름이 막히는 친구를 위해 준비했습니다. 최대한 사용하지 않고 풀어보세요.</span><br><br><div class="btn-group"><button type="button" class="btn btn-secondary popoverBtn" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-content="주머니 속 초대장을 발견했다면 소지품에 아이템이 등록됩니다. 소지품 내 아이템 버튼을 클릭하여 단서를 찾아보세요. m은 month(월) d는 day(일)을 뜻합니다">힌트1</button><button id="backButton" class="btn btn-secondary">이전</button></div>',

        '0423': '자물쇠를 풀자 안에는<br>양초와 성냥이 가득 들어있다.<br>배터리가 다 된 핸드폰은 꺼져버렸다.<br><br>초에 불을 붙이니 주변이 밝아졌다. <br>눈 앞에 정기간행물, 북큐레이션, 정수기가 보인다.<br><br><span class="small">🔔지문에서 관찰하려는 키워드를 입력해보세요.</span>',
        ...
        'BACK': 'BACK...? 뒤집으라는 뜻인가.<br>종이를 뒤집으니 또 다른 문장이 적혀있다.<br><br><span class="books">난 그림자로 끝나고 싶지 않아.<br>난 계속 모습을 드러내고 싶어.<br>"그것"을 꺼뜨리지 말고<br>내게 가까이 가져와 줘.</span><br><div class="btn-group"><button type="button" class="btn btn-secondary popoverBtn" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-content="책의 날 큐레이션 도서에서 힌트를 찾아보세요.">힌트4</button><button id="backButton" class="btn btn-secondary">이전</button></div>',

        '촛불': '들고있던 초를 종이에 가까이 대자 따뜻해진 종이에 숨겨진 글씨가 떠오른다.<br><br><span class="books">내 이름을 불러줘.<br>나는 어린왕자가 사랑한 존재.<br>나는 로미오와 줄리엣의 사랑의 상징.<br>세인트 조지의 날에 사람들에게 선물로 전해지는 것.</span>',
    ...
    const itemDescriptions = {
        '초대장': '세계 책의 날 도서관 행사에 초대합니다.\n\n[세계 책의 날이란?]\n1995년 국제연합총회에서 세계인의 독서증진을 위해 매년 4월 23일로 정함. 책을 사는 사람에게 꽃을 선물하는 스페인 까딸루니아 지방 축제일인 "세인트 조지의 날"과, 1616년 세르반테스와 셰익스피어가 동시에 사망한 날이 이날인 데서 유래...(중략)',
        '어린왕자': '커다란 책갈피가 꽂혀있는 페이지엔 이렇게 적혀있다.\n\n그러고서 나는 하나의 행성에 착륙했다. 그것은 소행성 B612였다. 지구에서는 매우 작은 행성이었지만 나에게는 이 세상에서 가장 아름답고 가장 소중한 것들 중 하나였다. 그것은 아름다운 장미를 품고 있었다.',
        '로미오와 줄리엣': ' 우리가 장미라 부르는 꽃은 다른 어떤 이름으로 불러도 달콤한 향기가 줄지 않아요.',
        '멕베스': '꺼져라, 꺼져라, 덧없는 촛불이여.\n인생은 한낱 흔들리는 그림자일 뿐.\n가련한 배우, 맡은 시간엔 무대 위에서\n활개치고 안달하지만\n얼마 안 가 영영 기억에서 지워져 버리지 않는가.'
    };

    const inputIndex = stages.indexOf(input);
    if (inputIndex !== -1 && inputIndex <= currentStage) {
        if (inputIndex === currentStage) {
            currentStage++; // Move to the next stage when the correct input is entered
        }
