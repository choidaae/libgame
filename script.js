...
function getInputResult(input) {
    const keyword = {
        ...
        '큐레이션': '창가 큐레이션 코너에 책이 놓여있다<br><br><br><span class="pp">[세계 책의 날 기념 큐레이션 도서]<br>노인과 바다, 어린왕자, 꽃들에게 희망을, 멕베스. 로미오와 줄리엣</span><br>눈 앞엔 메모지가 보인다<br><br><span class="books">소행성에서<br>숨겨진 코드를 찾아와.<br>C K I E N A V O</span><br><div class="btn-group"><button type="button" class="btn btn-secondary popoverBtn" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-content="[정기간행물] 코너는 둘러보셨나요?">힌트2  </button><button type="button" class="btn btn-secondary popoverBtn" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-content="숫자와 알파벳 배열을 매칭하세요. 예를 들어 5는 N입니다. 문제의 답은 소문자와 대문자와 띄어쓰기 구별합니다. 대문자로 적어주세요.">힌트3</button>  <button id="backButton" class="btn btn-secondary">이전</button></div>',
