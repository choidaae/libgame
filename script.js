...
function getInputResult(input) {
    const keyword = {
        ...
        '0423': '사물함 안에는 양초와 성냥이 가득 들어있다.<br>배터리가 다 된 핸드폰은 꺼져버렸다.<br><br>불을 붙이니 주변이 밝아졌다. <br>눈 앞에 정기간행물, 북큐레이션, 정수기가 보인다.<br><br><span class="small">🔔지문에서 관찰하려는 키워드를 입력해보세요.</span>',
