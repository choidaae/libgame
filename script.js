...
function getInputResult(input) {
    const keyword = {
        '시작': '어둠에 눈이 조금 익숙해지고 나서야 내가 도서관에 들어와있다는 걸 알았다. 쉬는시간에 잠깐 잠든 것 뿐인데 내가 왜 여기 있는거지?<br><br>일단 너무 어두워서 전등 스위치를 켜야겠다.<br><br><br><span class="small">🔔입력 키워드는 "지문 안"에 숨겨져 있습니다.<br><span class="bold">다음 장면</span>으로 이동하는 키워드일 수도 있고,<br>여러분들이 <span class="bold">탐색해야 하는 대상</span>일 수도 있습니다.<br><br>힌트를 드리죠. 지문에서 너무 어두워 스위치를 켜야겠다고 하네요! <span class="pp">스위치</span>를 입력해보세요.</span>',

        '스위치': '<br><br>달칵- 달칵- 전등이 켜지지 않는다. 핸드폰 플래시를 켜려고 주머니에 손을 넣으니 구겨진 초대장이 손에 잡힌다.<br>핸드폰 배터리는 5%밖에 남지 않아 금방이라도 꺼질 것 같다. 눈 앞엔 사물함이 보인다.<br><br><br><span class="small">🔔입력 키워드는 미스테리를 해결하기 위한<br><span class="bold">아이템</span>일 수도 있습니다.<br>힌트를 드리죠. 주머니에 손을 넣어 잡힌<br><span class="pp">OOO</span>을 입력창에 입력해보세요.<br><br>🔔그리고 "지문"에서 다음 장면으로 가기 위한<br>탐색<span class="pp">키워드</span>를 찾아 입력하세요.<br>눈 앞에 무엇이 보이나요?</span>',
        
        '사물함': '<br><br><br><br>사물함은 네자리의 자물쇠로 잠겨있다.<br>자물쇠 몸통엔 MMDD라고 적혀있다.<br><br><br><span class="small">🔔입력 키워드는 <span class=bold>문제의 답</span>을 요구하기도 합니다.<br>소지품 내 <span class="pp">아이템에 설명</span>에서<br>답을 찾을 수도 있습니다.<br>자물쇠 번호를 찾아 입력해보세요.<br><br>힌트는 스토리 흐름이 막히는 친구를 위해 준비했습니다. 최대한 사용하지 않고 풀어보세요.</span><br><br><div class="btn-group"><button type="button" class="btn btn-secondary popoverBtn" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-content="주머니 속 초대장을 발견했다면 소지품에 아이템이 등록됩니다. 소지품 창을 열어 아이템 버튼을 클릭하여 실마리를 찾아보세요. m은 month(월) d는 day(일)을 뜻합니다">힌트1</button><button id="backButton" class="btn btn-secondary">이전</button></div>',
        
        '0423': '자물쇠를 풀자 안에는<br>양초와 성냥이 가득 들어있다.<br>배터리가 다 된 핸드폰은 꺼져버렸다.<br><br>초에 불을 붙이니 주변이 밝아졌다. <br>눈 앞에 정기간행물, 북큐레이션, 정수기가 보인다.<br><br><span class="small">🔔지문에서 탐색하고자 하는 키워드를 입력해보세요</span>',
        
        '북큐레이션': '창가 큐레이션 코너에 책이 놓여있다<br><br><br><span class="pp">[세계 책의 날 기념 큐레이션 도서]<br>어린왕자, 꽃들에게 희망을, 멕베스,<br>노인과 바다, 로미오와 줄리엣</span><br>눈 앞엔 메모지가 보인다<br><br><span class="books">소행성에서<br>숨겨진 코드를 찾아와.<br>C K I E N A V O</span><br><div class="btn-group" onload="initPopovers()"><button type="button" class="btn btn-secondary popoverBtn" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-content="이전에 [정기간행물] 코너는 둘러보셨나요? 이곳에서 얻어야 하는 책에 대한 단서가 적혀있어요!">힌트2</button><button type="button" class="btn btn-secondary popoverBtn" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-content="작은 별에서 온 주인공은 누구일까요? 숫자와 알파벳 배열을 매칭하세요. 예를 들어 5는 N입니다. 대문자로 적어주세요.">힌트3</button>  <button id="backButton" class="btn btn-secondary">이전</button></div>',

        'BACK': 'BACK...? 뒤집으라는 뜻인가.<br>카드를 뒤집으니 또 다른 문장이 적혀있다.<br><br><span class="books">난 그림자로 끝나고 싶지 않아.<br>난 계속 모습을 드러내고 싶어.<br>"그것"을 꺼뜨리지 말고 내게 가까이 가져와 줘.</span><br><div class="btn-group" onload="initPopovers()"><button type="button" class="btn btn-secondary popoverBtn" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-content="책의 날 큐레이션 도서에서 힌트를 찾아보세요.">힌트4</button><button id="backButton" class="btn btn-secondary">이전</button></div>',
  ...
  const hints = {
      ...
      '최다애': '저를 찾아주시다니 영광이에요!',
      '셰익스피어': '셰익스피어 대표 작에는 오셀로, 멕베스, 로미오와 줄리엣, 한 여름밤의 꿈이 있어.',
      '세르반테스': '세르반테스와 셰익스피어의 사망일이 같다니 놀랄 일이군!'
  };
