...
function getInputResult(input) {
    const keyword = {
        ...
        '사물함': '<br><br><br><br>사물함은 네자리의 자물쇠로 잠겨있다.<br>자물쇠 몸통엔 MMDD라고 적혀있다.<br><br><br><span class="small">🔔입력 키워드는 <span class=bold>문제의 답</span>을 요구하기도 합니다.<br>소지품 내 <span class="pp">아이템 설명을 클릭</span>하여<br>답을 찾을 수도 있습니다.<br>자물쇠 번호를 찾아 입력해보세요.<br><br>힌트는 스토리 흐름이 막히는 친구를 위해 준비했습니다. 최대한 사용하지 않고 풀어보세요.</span><br><br><div class="btn-group"><button type="button" class="btn btn-secondary popoverBtn" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-content="주머니 속 초대장을 발견했다면 소지품에 아이템이 등록됩니다. 소지품 내 아이템 버튼을 클릭하여 단서를 찾아보세요. m은 month(월) d는 day(일)을 뜻합니다">힌트1</button><button id="backButton" class="btn btn-secondary">이전</button></div>',
